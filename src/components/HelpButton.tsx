...
export const HelpButton: React.FC = () => (
  <ModalButton buttonLabel="Help" modalClassName="help-modal">
    ...
    <div>
      ...
      <p>
        To place a single qubit gate on the circuit, drag it from the toolbox on the left side, and
        drop the desired gate at the desired moment and qubit in the circuit.
      </p>
      <p>
        To place a two qubit gate, first drop the gate symbol on the desired location, this will be
        your target. Then place your control or your second target on a different qubit in the same
        moment. To drag a two qubit gate always take it by its target or control qubit.
      </p>
      <p>
        When placing a gate on top of another gate, the old gate and all subsequent elements of the
        circuit get pushed one moment to the right.
      </p>
      <p>
      ...
      <p>
        If more qubits are needed drop a gate below the last qubit and the gate is automatically
        assigned to the next qubit.
      </p>
